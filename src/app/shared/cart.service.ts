...
export class CartService {
  ...
  address = [
    'Odell J. Gabbert 1045 Kildeer DriveNorfolk, VA 23502',
    'Thelma E. Rogers 3651 Burton AvenueMemphis, TN 38104',
    'Kathleen G. Hogan3516 Layman AvenueFayetteville, NC 28306',
  ];
}
